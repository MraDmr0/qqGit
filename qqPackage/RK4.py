...
@njit
def rk4_qb(psi0 , t0 , tf , N , S , wr , wl , w , E ):
   ...
   #RK4 cycle
    for j in range(1 , N+1):
        ...
        V  = potential_qb(t[j-1] , dt , wrr, w , E[j-1] )
    ...
    return psiff , tff , Eout

@njit
def rk4_qq(psi0 , t0 , tf , N , S , wr , wl , w , E ):
    #definition of time array
    dt = (tf-t0)/N
    t = np.linspace(t0 , tf , N+1)
    ...
    for j in range(1 , N+1):
        ...
        V  = potential_qq(t[j-1] , dt , wr , wl , w , E[j-1] )
